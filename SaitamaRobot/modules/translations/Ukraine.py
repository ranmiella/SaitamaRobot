RUN_STRINGS = (
    "Mana Apakah Anda pikir Anda akan?",
    "Ya? apa? apakah mereka bisa lolos?",
    "ZZzzZZzz... Hah? Apa? oh, hanya mereka lagi, jangan dipikirkan.",
    "Kembali ke sini!",
    "Tidak begitu cepat...",
    "Melihat untuk dinding!",
    "Jangan tinggalkan aku sendirian dengan mereka!!",
    "Anda Lari, Anda mati.",
    "Lelucon pada Anda, saya di mana-mana",
    "Anda akan menyesal...",
    "Anda juga dapat mencoba /kickme, itu menyenangkan.",
    "Pergi mengganggu orang lain, tidak ada orang di sini yang peduli."
    "Anda dapat lari, tapi Anda tidak dapat bersembunyi.",
    "Adalah, bahwa semua yang Anda punya?"
    "Aku di belakang Anda...",
    "Anda punya perusahaan!",
    "Kita dapat melakukan ini dengan cara yang mudah, atau dengan cara yang keras.",
    "Anda hanya tidak mengerti, kan?",
    "Ya, Anda lebih baik lari!",
    "Tolong, mengingatkan saya betapa aku peduli?",
    "Aku akan berjalan lebih cepat jika aku jadi kau.",
    "Itu adalah pasti droid kami mencari.",
    "Kemungkinan mungkin pernah dalam mendukung Anda.",
    "Kata-kata terakhir yang terkenal.",
    "Dan mereka hilang selamanya, tidak pernah terlihat lagi."
    "Oh, lihat aku! Aku begitu dingin, saya dapat menjalankan dari bot! \n -orang ini",
    "Ya Ya, hanya tekan /kickme.",
    "Di sini, mengambil ini cincin dan kepala ke Mordor sementara kau di itu.",
    "Legenda memilikinya, mereka masih berlari...",
    "Tidak seperti Harry Potter, orang tuamu tidak bisa melindungimu dariku.",
    "Ketakutan mengarah pada kemarahan. Kemarahan menyebabkan kebencian. Benci menyebabkan penderitaan. Jika Anda terus berlari dalam ketakutan, Anda mungkin "
    "jadilah Vader berikutnya.",
    "Beberapa perhitungan nanti, aku telah memutuskan bahwa ketertarikanku pada kejahatanmu adalah tepat 0.",
    "Legenda memilikinya, mereka masih berlari.",
    "Terus, tidak yakin kami mau kamu di sini.",
    "Anda akan menyesal. Tunggu. Anda bukan Harry, terus bergerak.",
    "TIDAK BERLARI DI LORONG!",
    "Hasta la vista, baby.",
    "Siapa membiarkan Anjing keluar?",
    "Pergi mengganggu orang lain, tidak ada orang di sini yang peduli."
    ...
    "Waktu yang lama yang lalu, di sebuah galaksi jauh jauh... Seseorang akan pernah peduli tentang hal itu. Tidak lagi walaupun. ",
    "Hei, lihat mereka! Mereka menjalankan dari banhammer tak terelakkan... Lucu. ",
    "Han menembak terlebih dahulu. Begitu juga aku.",
    "Apa yang Anda menjalankan setelah, kelinci putih?",
    "Sepertinya dokter akan mengatakan... LARI! ",
)

INSULTS_STRINGS = (
    "Owww ... Begitu bodoh idiot.",
    "Jangan minum dan mengetik",
    "Saya pikir Anda harus pulang atau mental yang lebih baik.",
    "Perintah tidak ditemukan. Seperti otak Anda.",
    "Apakah Anda menyadari Anda membuat bodoh diri sendiri? Tampaknya tidak.",
    "Anda dapat mengetik lebih dari itu.",
    "Bot aturan 544 Bagian 9 mencegah saya dari membalas tindakan bodoh dari manusia seperti kamu.",
    "Maaf, kami tidak menjual otak.",
    "Percayalah Anda tidak normal.",
    "Aku yakin otak Anda terasa seperti baru, melihat bahwa Anda tidak pernah menggunakannya.",
    "Jika saya ingin bunuh diri saya akan naik ego Anda dan melompat ke IQ anda.",
    "Zombie makan otak... kau aman. ",
    "Anda tidak berevolusi dari kera, mereka berevolusi dari Anda."
    "Datang kembali dan berbicara dengan saya ketika Anda sudah menggunakan otak. melebihi usia Anda. ",
    "Saya tidak mengatakan anda gila, Sata hanya mengatakan anda kurang beruntung saat berfikir.",
    "Bahasa apa yang anda pakai? Karena itu terdengar seperti omong kosong",
    "Kegilaanmu bukan sebuah kejahatan jadi kamu bebas untuk pergi.",
    ...
    "Aku tidak tahu apa yang membuatmu gila, tapi ini bekerja.",
    "Terus berbicara, suatu hari nanti Anda akan mengatakan sesuatu yang cerdas! (Saya ragu itu meskipun) ",
    "Shock saya, mengatakan sesuatu yang cerdas."
    "IQ mu lebih kecil dari ukuran sepatumu.",
    "Sayang! Neurotransmiter Anda adalah bekerja lagi. ",
    "Apakah Anda gila anda terlalu bodoh.",
    "Setiap orang mempunyai hak untuk menjadi bodoh tapi Anda yang menyalahgunakan hak istimewa.",
    "Aku menyesal aku menyakiti perasaan Anda ketika aku memanggil Anda bodoh. Saya pikir Anda sudah tahu bahwa. ",
    ...
    "Mencoba melompat dari seratus bangunan lantai tetapi Anda dapat melakukannya hanya sekali.",
    "Kamu harus menyumbangkan otakmu saya melihat bahwa kamu tidak pernah menggunakannya.",
    "Relawan untuk target dalam jarak tembak.",
    "Tembakan kepala itu menyenangkan. Dapatkan sendiri satu. ",
    "Kamu harus coba berenang bersama hiu putih.",
    "Kamu harus mengecat dirimu sendiri warna merah dan berlari dalam maraton banteng.",
    ...
    "Sudahkah Anda mencoba menembak diri sendiri sejauh 100 m menggunakan kanon.",
    ...
    "Kawah adalah kolam renang terbaik untukmu.",
...
MARKDOWN_HELP = """
Markdown adalah alat pemformatan yang sangat baik yang didukung oleh telegram. {} memiliki beberapa peningkatan, untuk memastikan bahwa \
...
- <code>[buttontext](buttonurl:someURL)</code>: ini adalah penyempurnaan khusus untuk memungkinkan pengguna telegram \
tombol dalam markdown mereka. <code>buttontext</code> akan menjadi apa yang ditampilkan pada tombol, dan <code>someurl</code> \
...
python-telegram-bot library, dan saya sepenuhnya opensource - Anda dapat menemukan apa yang membuat saya\
[disini](https://github.com/peaktogoo/HarukaAya))!

Jangan ragu untuk mengirimkan permintaan tarik di github\
atau permintaan fitur yang mungkin Anda miliki :)

Jika Anda menikmati menggunakan saya dan / atau ingin membantu saya bertahan di alam liar, tekan /donate untuk membantu upgrade VPS saya!
""",
...
"AFK_help": """ - /afk <reason>: tandai diri Anda sebagai AFK.
 - brb <reason>: sama dengan perintah afk - tetapi bukan perintah.

Ketika ditandai sebagai AFK, sebutan apa pun akan dijawab dengan pesan untuk mengatakan bahwa Anda tidak tersedia! """,
...
Antiflood memungkinkan Anda untuk mengambil tindakan pada pengguna yang mengirim lebih x pesan berturut-turut. Tindakan: ban/tendangan/mute/tban/tmute
...
"Locks_help": """Apakah stiker mengganggu Anda? atau ingin menghindari orang-orang yang berbagi link? atau gambar? Anda berada di tempat yang tepat!

Modul kunci memungkinkan Anda untuk mengunci berjarak beberapa item yang umum di dunia telegram; bot akan secara otomatis menghapus mereka!
...
Ini memungkinkan Anda untuk menonaktifkan beberapa digunakan perintah, sehingga tidak ada dapat menggunakan mereka. Ini juga akan memungkinkan Anda untuk autodelete mereka, menghentikan orang-orang dari
...
Perintah Penyandang Cacat masih dapat diakses melalui /connect fitur. Jika Anda akan tertarik untuk melihat ini dinonaktifkan juga, biarkan aku tahu dalam obrolan dukungan.""", 

"Filters_help": """Membuat obrolan lebih ramai dengan filter; Bot akan membalas dengan kata-kata tertentu!
Filter tidak peka huruf besar-kecil; setiap kali seseorang mengatakan kata-kata pemicu Anda, {} akan membalas sesuatu yang lain! dapat digunakan untuk membuat perintah Anda sendiri, jika diinginkan.
...
`/filter kata saat menjawab stiker atau data apa pun yang Anda inginkan. Sekarang, setiap kali seseorang menyebut "kata", stiker itu akan dikirim sebagai balasan.`
...
Modul ini memungkinkan Anda untuk melakukannya dengan mudah, dengan memaparkan beberapa tindakan umum, sehingga semua orang akan melihat!

Perintah yang tersedia adalah:
 - /ban: melarang pengguna dari obrolan Anda.
 - /banme: melarang diri sendiri
 - /tban: sementara melarang pengguna dari obrolan Anda. setel waktu menggunakan int <d/h/m> (hari jam menit)
 - /unban: batalkan pengguna dari obrolan Anda.
 - /sban: diam-diam melarang pengguna. (via gagang, atau balas)
 - /mute: membisukan pengguna dalam obrolan Anda.
 - /tmute: untuk sementara menonaktifkan pengguna di obrolan Anda. setel waktu menggunakan int <d/h/m> (hari jam menit)
...
"Connections_help": """kadang-kadang, Anda hanya ingin menambahkan beberapa catatan dan filter ke grup obrolan, tetapi Anda tidak ingin semua orang untuk melihat; Ini adalah di mana sambungan datang...

Hal ini memungkinkan Anda untuk menghubungkan ke database chatting, dan menambahkan sesuatu untuk itu tanpa chat mengetahui tentang hal itu! Untuk alasan yang jelas, Anda perlu untuk menjadi seorang admin untuk menambahkan hal-hal; tapi setiap anggota dapat melihat data Anda. (pengguna dilarang/menendang tidak bisa!)
...
Tindakan tersedia dengan kelompok-kelompok yang terhubung:
 ...
 Anda dapat mengambil id chatting dengan menggunakan perintah /id dalam obrolan Anda. Jangan terkejut jika id ada negatif; Semua kelompok yang super memiliki Id negatif.""",
...
*Admin only:*
 - /reports <on/off>: mengubah pengaturan laporan, atau melihat status saat ini.
   - Jika dilakukan pada pm, matikan status Anda.
...
Jika Anda ingin menyimpan gambar, gif, atau stiker, atau data lain, lakukan hal berikut:
/save word saat membalas stiker atau data apa pun yang Anda inginkan. Sekarang, catatan di "#word" berisi stiker yang akan dikirim sebagai balasan.

Kiat: untuk mengambil catatan tanpa memformat, gunakan /get <notename> noformat
Ini akan mengambil catatan dan mengirimkannya tanpa memformatnya; memberi Anda markdown mentah, memungkinkan Anda untuk mengedit dengan mudah""",
...
"Misc_help": """ - /id: get the current group id. Jika digunakan dengan membalas pesan, dapatkan id pengguna itu.
 ...
 - /gdpr: menghapus informasi Anda dari basis data bot. Obrolan pribadi saja.
 - /stickerid: balas stiker ke saya untuk memberi tahu Anda file ID-nya.
 ...
 - /lyrics: Temukan lirik lagu favorit Anda!
 ...
 - /ud: Ketikkan kata atau ungkapan yang ingin Anda cari. Misalnya /ud Gay
 - /removebotkeyboard: Punya keyboard bot jahat tersangkut di grup Anda?
...
"Bios and Abouts_help": """ - /setbio <text>: saat menjawab, akan menambah bio pengguna lain
 ...
 - /setme <text>: memperbarui info anda
...
Beri anggota Anda sambutan hangat dengan modul salam! Atau selamat tinggal yang menyedihkan... Tergantung!
...
Perintah yang tersedia adalah:
 ...
 - /setwelcome <message>: set pesan sambutan baru Anda! Markdown dan tombol didukung, serta tambalan.
 - /resetwelcome: mengatur ulang pesan sambutan Anda ke default; menghapus semua perubahan yang telah Anda buat.
 - /setgoodbye <message>: set pesan selamat tinggal Anda! Markdown dan tombol didukung, serta tambalan.
 - /resetgoodbye: mengatur ulang pesan selamat tinggal Anda ke default; menghapus semua perubahan yang telah Anda buat.
 - /cleanwelcome <on/off/yes/no>: menghapus pesan sambutan lama; ketika orang baru bergabung, pesan lama dihapus.
 - /cleanservice <on/off/yes/no>: menghapus semua pesan layanan; itu adalah "x bergabung dengan grup" yang Anda lihat ketika orang bergabung.
...
Fillings:
Seperti disebutkan, Anda dapat menggunakan tag tertentu untuk mengisi pesan selamat datang Anda dengan pengguna atau info obrolan; ada:
...
Anda dapat mengaktifkan / menonaktifkan pesan sambutan seperti:
/welcome off

Jika Anda ingin menyimpan gambar, gif, atau stiker, atau data lain, lakukan hal berikut:
/setwelcome saat membalas stiker atau data apa pun yang Anda inginkan. Data ini sekarang akan dikirim untuk menyambut pengguna baru.
...
"Word Blacklists_help":"""Anda dapat mengatur filter daftar hitam untuk mengambil tindakan otomatis pada orang-orang ketika mereka mengatakan hal-hal tertentu. Ini dilakukan dengan menggunakan:
 - /addblacklist <blacklist trigger> <blacklist reason>: daftar hitam pemicunya. Anda dapat mengatur kalimat dengan menaruh tanda kutip di sekitar alasannya.
...
Jika Anda telah mengaktifkan mode daftar hitam alternatif, itu akan memperingatkan, mencekal, menendang, atau membisukan pengguna dengan pesan yang menyebutkan alasannya.

Top tip:
Daftar hitam memungkinkan Anda menggunakan beberapa pengubah untuk mencocokkan karakter "unknown". Misalnya, Anda dapat menggunakan? karakter untuk mencocokkan satu kemunculan $
Anda juga dapat menggunakan * pengubah, yang sesuai dengan sejumlah karakter apapun. Jika Anda ingin daftar hitam Url, ini akan memungkinkan Anda untuk menyesuaikan secara penuh $
Sebagai contoh, berikut akan melarang bit.ly link:
/addblacklist "bit.ly/*" kita tidak menyukai layanan pemendek!
Jika Anda ingin hanya cocok bit.ly/ link diikuti oleh tiga karakter, Anda dapat menggunakan:
/addblacklist "bit.ly/???" Kita tidak menyukai layanan pemendek!
...
Perintah yang tersedia adalah:
 - /purge: menghapus semua pesan dari pesan Anda menjawab, untuk pesan yang sekarang.
 - /purge X: menghapus X pesan setelah pesan Anda membalas (termasuk menjawab pesan)
 -/del: menghapus pesan yang Anda jawab.
""",
...
#GDPR
"send-gdpr": """Data pribadi Anda telah dihapus.\n\nPerhatikan bahwa ini tidak akan mebatalkan blokir \
anda dari obrolan apa pun, karena itu adalah data telegram, bukan data Bot.
Flooding, warns, dan gbans juga dipertahankan, seperti pada \
